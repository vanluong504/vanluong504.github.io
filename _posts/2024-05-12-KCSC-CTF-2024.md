...
Mình sẽ lấy ra ``token_hex[32:128]`` tương ứng sau khi giải mã là ``{"username":           "admin", "isAdmin": true}``

Tiếp đó mình sẽ gửi ``\x00\x00\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10``

Mục tiêu để lấy ``token_hex[32:64]`` tức là đoạn ``\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10`` để khi đó signature có giá trị, cuối cùng ``verify = {"username":           "admin", "isAdmin": true}`` thông qua json.loads() của admin thì nó sẽ trở thành ``{"username": "admin", "isAdmin": false}`` (DPCM)
